...
from nets.yolo import YoloBody_base, YoloBody_PM
...
def parser_opt():
    ...
    parser.add_argument('--weights', '-w',type=str,default='model_data/yolov5_l.pth')
    parser.add_argument('--cfg', type=str, default='')
    parser.add_argument('--classes_path', '--cls', type=str, default='model_data/HiXray_classes.txt')
    parser.add_argument('--cuda', type=bool, default=True)
    parser.add_argument('--pretrained', type=bool, default=False)
    parser.add_argument('--save_period', type=int, default=5)
    parser.add_argument('--log_save', type=str, default='logs/HiX/base_200')

    parser.add_argument('--train_anno', type=str, default='HiXray_train.txt')
    parser.add_argument('--val_anno', type=str, default='HiXray_val.txt')
    parser.add_argument('--anchors', type=str, default='yolo_anchors_HiXray_640.txt')
    parser.add_argument('--num_works', type=int, default=8)
    parser.add_argument('--freeze_train', '--fz', type=bool, default=True)
    parser.add_argument('--img_weights', type=bool, default=False)
...
if __name__ == "__main__":
    ...
    #------------------------------------------------------#
    train_annotation_path   = opt.train_anno
    val_annotation_path     = opt.val_anno
